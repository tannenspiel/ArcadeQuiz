...
// Если USE_CUSTOM_FONT = true, используем PixeloidSans, иначе (или как fallback) Nunito
// Старый шрифт: 'Nunito'
...
export const FONT_SIZE_MULTIPLIERS = {
  ULTRA_NARROW: 1.26,   // Экстремально узкие (AR 0.25-0.45) — было 1.15 (+9.6%)
  EXTRA_NARROW: 1.34,   // Очень узкие (AR 0.45-0.6) — было 1.22 (+9.8%)
  MOBILE_NARROW: 1.41,  // Узкие мобильные (AR 0.6-0.75) — было 1.28 (+10.2%)
  MOBILE_STANDARD: 1.45, // Стандартные мобильные (AR 0.75-1.0) — было 1.32 (+9.8%)
  TABLET_SQUARE: 1.49,  // Планшеты, квадратные (AR 1.0-1.3) — было 1.35 (+10.4%)
  MONITOR_SMALL: 1.54,   // Небольшие мониторы (AR 1.3-1.6) — было 1.4 (+10%)
  MONITOR_LARGE: 1.54    // Большие мониторы (AR 1.6+) — было 1.4 (+10%)
} as const;
