/**
 * Враг со случайным блужданием
 * Не преследует игрока, движется случайными направлениями
 */
...
export class EnemyRandomWalker extends AbstractEnemy {
  ...
  /**
   * AI для случайного блуждания с опциональным преследованием
   */
